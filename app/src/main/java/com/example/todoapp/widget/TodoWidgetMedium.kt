...
class TodoWidgetMedium : AppWidgetProvider() {
    ...
    companion object {
        fun updateAppWidget(
            ...
            val views = RemoteViews(context.packageName, R.layout.todo_widget_medium)
            ...
            val todoText = if (unfinishedItems.isEmpty()) {
                ...
                unfinishedItems.take(3).joinToString("\n") { "• ${it.title}" }
            }
            ...
            val refreshIntent = Intent(context, TodoWidgetMedium::class.java).apply {
